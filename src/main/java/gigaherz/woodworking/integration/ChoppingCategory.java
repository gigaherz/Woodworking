...
{
    private static final ResourceLocation GUI_TEXTURE_LOCATION = WoodworkingMod.location("textures/gui/conversion.png");
    private static final ResourceLocation JEI_RECIPE_GUI_VANILLA = new ResourceLocation("jei", "textures/gui/gui_vanilla.png");
    public static final ResourceLocation UID = WoodworkingMod.location("chopping");
    ...
    public ChoppingCategory(IGuiHelper guiHelper)
    {
        ...
        icon = guiHelper.createDrawableIngredient(new ItemStack(WoodworkingBlocks.OAK_CHOPPING_BLOCK.get()));
