...
public class WoodworkingBlocks
{
    ...
    public static final RegistryObject<SawmillBlock> SAWMILL = HELPER
            ...
            .withItem(new Item.Properties().group(WoodworkingMod.WOODWORKING_ITEMS)).withTileEntity(SawmillTileEntity::new).defer();
    ...
    public static final RegistryObject<ChoppingBlock> OAK_CHOPPING_BLOCK = HELPER
            ...
            .withItem(new Item.Properties().group(WoodworkingMod.WOODWORKING_ITEMS)).defer();
